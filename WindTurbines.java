...
public class WindTurbines
{
    ...
    public static String stateWithMost(ArrayList<String[]> windData) {
        if (windData.size() <= 1) {
    ...
    public static void main(String[] args) {
        ...
        while (!input.equals("Q")) {
            ...
            System.out.println("4. State with the most Wind Turbines");
            ...
            if (input.equals("1")) {
                ...
                System.out.println("The State with the most Wind Turbines is " + stateWithMost(windData));
            } 
